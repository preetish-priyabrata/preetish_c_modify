                 ...
                 <label for="District">District :</label>
                  ...
                  <label for="village">Type farmer:</label>
                    <select class="form-control" id="farm_type" name="farm_type" required="">
                      ...
                      <option value="2" <?php if($farm_type==2){echo "selected";}?>>Influenced farmer</option>
                    <option value="1" <?php if($farm_type==1){echo "selected";}?>>Demo farmer</option>
                    </select>
                 ...
                 <table id="example" class="display" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo  $total_input=$fetch_result[1]?></td>
                      <td><?=$total_count=$fetch_result[0]?></td>
                      <td><?php echo ($total_input."/".$total_count)." = ";
                          echo  round(($total_input/$total_count),2);
                    ...
                    <?php
                     ...
                     $get_village_sv="SELECT * FROM `care_master_village_info` WHERE `care_vlg_district`='$District'";
                          ...
                          while($result_village_sv=mysqli_fetch_assoc($sql_get_village_sc)){
                            ...
                            $get_datas_sC="SELECT count(*),sum(`care_QR_seed`),AVG(`care_QR_seed`) FROM `care_master_crop_diversification_crp` WHERE `care_CRP_month`='$months' and `care_CRP_year`='$Year' and `care_CRP_vlg_name`='$care_vlg_name1_sc' and `care_demo_plot_farmer`='$farm_type'  ";
                            $sql_get_datas_SC=mysqli_query($conn,$get_datas_sC);
                                 $fetch_result_sC=mysqli_fetch_row($sql_get_datas_SC);
                                 // print_r($fetch_result_sC);
