              ...
              <form class="form-inline" action="" method="POST">
                <div class="form-group">
                 ...
                 <?php }
                    ...
                    <br>
                    <br>
                    <label for="domain">Domain wise</label>
                    <select class="form-control" id="domain" name="domain">
                      <option value="1" <?php if($domain=='1'){echo "selected";}?>>Goatery</option>
                      <option value="1-2" <?php if($domain=='1-2'){echo "selected";}?>>Dairy</option>
                      <option value="1-2-3"  <?php if($domain=='1-2-3'){echo "selected";}?>>Poultry</option>
                    </select>
                    ...
                    <thead>
                      <tr>
                        ...
                        <?php  if($form_type==0 ||$form_type==3 ){
                            switch ($domain) {
                              case '1':
                                echo " <h4><b>Goatery</b></h4>";
                                break;
                              case '1-2':
                                 echo " <h4><b>Dairy</b></h4>";
                                break;
                              case '1-2-3':
                                 echo " <h4><b>Poultry</b></h4>";
                                break;
