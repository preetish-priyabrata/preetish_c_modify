                    ...
                    ?>
                     ...
                     <table class="table table-striped table-bordered" cellspacing="0" >
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th colspan="2">Average number of female participants (Total) </th>
                          <td>
                              <?php
                              $get_data="SELECT AVG(`care_EV_male_Participants`),AVG(`care_EV_female_Participants`),SUM(`care_EV_male_Participants`),Sum(`care_EV_female_Participants`),COUNT(*) FROM `care_master_mrf_exposure_visit_tarina` WHERE`care_EV_month`='$months' AND `care_EV_year`='$Year'  and `care_EV_district_name`='$District' ";
                 ...
                 google.charts.load('current', {'packages':['bar']});
                  ...
                  function drawStuff() {
                      ...
                      var data = google.visualization.arrayToDataTable([
                       ['village',  'Female'],
                        <?php 
                        $get_data_sc="SELECT AVG(`care_EV_male_Participants`),AVG(`care_EV_female_Participants`),SUM(`care_EV_male_Participants`),Sum(`care_EV_female_Participants`),COUNT(*) FROM `care_master_mrf_exposure_visit_tarina` WHERE`care_EV_month`='$months' AND `care_EV_year`='$Year' and `care_EV_district_name`='$District'";
