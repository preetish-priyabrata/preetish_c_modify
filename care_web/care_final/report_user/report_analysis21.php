                 ...
                 <table id="example" class="display" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th>Total</th>
                      <th>No of Entry</th>
                      <th>Average quantity of input received per KG</th>                        
                    </tr>
                  </thead>
                  <tbody>
                     <?php
                     // `care_QR_seed`, `care_QR_fertiliser`, `care_QR_pesticides`, `care_QR_other`
                          ...
                          while($result_village=mysqli_fetch_assoc($sql_get_village)){
                            ...
                            $get_datas="SELECT count(*),sum(`care_QR_seed`),sum(`care_QR_fertiliser`),sum(`care_QR_pesticides`),sum(`care_QR_other`) FROM `care_master_crop_diversification_crp` WHERE `care_CRP_month`='$months' and `care_CRP_year`='$Year' and `care_CRP_vlg_name`='$care_vlg_name1' and `care_form_type`='$frame'  ";
             ...
             <script type="text/javascript">
                ...
                function drawChart() {
                  ...
                  var data = google.visualization.arrayToDataTable([
                    ['Village', 'KG farmer receive'],
                    <?php

                     $get_village_sv="SELECT * FROM `care_master_village_info` WHERE `care_vlg_district`='$District' ";
                          ...
                          while($result_village_sv=mysqli_fetch_assoc($sql_get_village_sc)){
                            ...
                            $get_datas_sC="SELECT count(*),sum(`care_QR_seed`),sum(`care_QR_fertiliser`),sum(`care_QR_pesticides`),sum(`care_QR_other`) FROM `care_master_crop_diversification_crp` WHERE `care_CRP_month`='$months' and `care_CRP_year`='$Year' and `care_CRP_vlg_name`='$care_vlg_name1_sc' and `care_form_type`='$frame' ";
