                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                              ...
                              $get_data="SELECT * FROM `care_master_mrf_exposure_visit_tarina` WHERE`care_EV_month`='$months' AND `care_EV_year`='$Year' and `care_EV_external_resource`!='no'  and `care_EV_district_name`='$District' ";
