  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">PHL </a></li>
        <li class="active"><a href="#">Edit PHL  </a></li>
    ...
    <section class="content">
      ...
      <?php
        ...
        if(!empty($village)){
          // 
          // 
          $get_detail="SELECT * FROM `care_master_post_harvest_loss` WHERE `care_PHL_villege_name`='$village' AND `care_PHL_month`='$months' AND `care_PHL_year`='$Year' and `care_PHL_MEO_status`='0'";
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          if (($sql_get_detail_fetch['care_PHL_CBO_comment_status']==1)&& ($sql_get_detail_fetch['care_PHL_mt_comment_status']==1)) {
                            ?>
                               <a class="btn btn-primary btn-xs" href="MEO_go_form_go.php?form_type=<?=web_encryptIt('ilab')?>&form_id=<?=web_encryptIt('7')?>&care_hhi=<?=web_encryptIt($sql_get_detail_fetch['care_PHL_slno'])?>&target=<?=web_encryptIt($months)?>&year=<?=web_encryptIt($Year)?>&village=<?=web_encryptIt($village)?>&form_uses=1" ><u>Edit</u></a>
                            <?php
                          }else{
                            echo "--";
