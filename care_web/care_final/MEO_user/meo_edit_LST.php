  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">LST </a></li>
        <li class="active"><a href="#">Edit LST  </a></li>
    ...
    <section class="content">
      ...
      <?php
        ...
        if(!empty($village)){
          // 
          // 
          $get_detail="SELECT * FROM `care_master_mtf_labour_saving_tech_tarina` WHERE `care_MTF_vlg_name`='$village' AND `care_MTF_month`='$months' AND `care_MTF_year`='$Year' and `care_MTF_MEO_status`='0'";
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          if (($sql_get_detail_fetch['care_MTF_mt_comment_status']==1)&& ($sql_get_detail_fetch['care_MTF_CBO_comment_status']==1)) {
                            ?>
                               <a class="btn btn-primary btn-xs" href="MEO_go_form_go.php?form_type=<?=web_encryptIt('ilab')?>&form_id=<?=web_encryptIt('8')?>&care_hhi=<?=web_encryptIt($sql_get_detail_fetch['care_MTF_slno'])?>&target=<?=web_encryptIt($months)?>&year=<?=web_encryptIt($Year)?>&village=<?=web_encryptIt($village)?>&form_uses=1" ><u>Edit</u></a>
                            <?php
                          }else{
                            echo "--";
