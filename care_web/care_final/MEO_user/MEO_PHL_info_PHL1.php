...
$fdate = date("F", strtotime("2017-$monthPadding-01"));
  ...
  $get_detail="SELECT * FROM `care_master_post_harvest_loss_meo` WHERE `care_PHL_villege_name`='$village' AND `care_PHL_month`='$months' AND `care_PHL_year`='$year' and `care_PHL_MEO_status`='1' and  `care_PHL_slno`='$id'";
    $sql_get_detail=mysqli_query($conn,$get_detail);
  $sql_get_detail_fetch=mysqli_fetch_assoc($sql_get_detail);
$care_hhi=$sql_get_detail_fetch['care_PHL_hhid'];
                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    ...
                    <table id='example11' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                          $get_phl="SELECT * FROM `care_master_post_harvest_loss_meo` WHERE`care_PHL_slno`='$id' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1'and `care_PHL_CBO_comment_status`='1' and `care_PHL_MEO_status`='1'";
                  ...
                  <table id='example12' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php  $get_ph2="SELECT * FROM `care_master_post_harvest_loss_meo` WHERE`care_PHL_slno`='$id' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1' and `care_PHL_CBO_comment_status`='1' and `care_PHL_MEO_status`='1'";
                  ...
                  <table id='example13' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                         $get_ph3="SELECT * FROM `care_master_post_harvest_loss_meo` WHERE`care_PHL_slno`='$id' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1' and `care_PHL_CBO_comment_status`='1' and `care_PHL_MEO_status`='1'";
