            ...
            <div class="panel-body">
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  $x=0;
                   $get_training="SELECT * FROM `care_master_mrf_exposure_visit_tarina` WHERE `care_EV_vlg_name`='$village' and `care_EV_month`='$months' and `care_EV_year` ='$Year'  and `care_EV_MEO_status`='0' ";
                        ...
                        <td>
                          ...
                          <td><?php 
                                  if(($res1['care_EV_mt_comment_status']==1) && ($res1['care_EV_CBO_comment_status']==1)){
                                    ?>
                                     <a class="btn btn-primary btn-xs" href="MEO_go_form_go.php?form_type=<?=web_encryptIt('ilab')?>&form_id=<?=web_encryptIt('20')?>&care_hhi=<?=web_encryptIt($res1['care_EV_slno'])?>&target=<?=web_encryptIt($months)?>&year=<?=web_encryptIt($Year)?>&village=<?=web_encryptIt($village)?>&form_uses=1" ><u>Edit</u></a>
