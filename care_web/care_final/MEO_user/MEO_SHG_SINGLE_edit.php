...
$form_uses_id=web_decryptIt(str_replace(" ", "+",$_GET['form_uses_id']));
 ...
 $get_shg="SELECT * FROM `care_master_village_info` WHERE `care_vlg_name`='$village'";
  ...
  $get_detail_query="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_month`='$months' and `care_SHG_year`='$year'  and `care_SHG_MEO_status`='0' and `care_SHG_slno`='$id' ";
                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                         $get_detail_query="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village'  and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_MEO_status`='0' and `care_SHG_CBO_comment_status`='1' and `care_SHG_slno`='$id' ";
                  ...
                  <div id="part2" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                         <?php 
                          $get_detail_query1="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village'  and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_MEO_status`='0' and `care_SHG_CBO_comment_status`='1' and `care_SHG_slno`='$id' ";
                  ...
                  <div id="part3" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                           <?php 
                        $get_detail_query2="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village'  and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_MEO_status`='0' and `care_SHG_CBO_comment_status`='1' and `care_SHG_slno`='$id' ";
                  ...
                  <div id="part4" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                        $get_detail_query3="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village'  and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_MEO_status`='0' and `care_SHG_CBO_comment_status`='1' and `care_SHG_slno`='$id' ";
                  ...
                  <div id="part5" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                      <?php 
                        $get_detail_query4="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village'  and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_MEO_status`='0' and `care_SHG_CBO_comment_status`='1' and `care_SHG_slno`='$id' ";
