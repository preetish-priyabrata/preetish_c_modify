...
if($_SESSION['meo_user']){
 ...
 $form_uses_id=web_decryptIt(str_replace(" ", "+",$_GET['form_uses_id']));
  ...
  $get_detail="SELECT * FROM `care_master_post_harvest_loss` WHERE `care_PHL_villege_name`='$village' AND `care_PHL_month`='$months' AND `care_PHL_year`='$year' and `care_PHL_MEO_status`='0' and  `care_PHL_slno`='$id'";
                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                          $get_phl="SELECT * FROM `care_master_post_harvest_loss` WHERE `care_PHL_slno`='$id' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1'and `care_PHL_CBO_comment_status`='1' and `care_PHL_MEO_status`='0'";
                  ...
                  <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php  $get_ph2="SELECT * FROM `care_master_post_harvest_loss` WHERE `care_PHL_slno`='$id' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1' and `care_PHL_CBO_comment_status`='1' and `care_PHL_MEO_status`='0'";
                  ...
                  <div id="part3" class="tab-pane fade">
                   ...
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                         $get_ph3="SELECT * FROM `care_master_post_harvest_loss` WHERE `care_PHL_slno`='$id' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1' and `care_PHL_CBO_comment_status`='1' and `care_PHL_MEO_status`='0'";
