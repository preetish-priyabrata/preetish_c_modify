  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">View after edit by Meo JKitich Gsrden</a></li>
    ...
    <section class="content">
      ...
      <?php
        ...
        if(!empty($village)){
          // 
          // 
          $get_detail="SELECT * FROM `care_master_crop_diversification_crp_meo` WHERE  `care_type_farm`='4' and `care_form_type`='2' and `care_CRP_vlg_name`='$village' AND `care_CRP_month`='$months' AND `care_CRP_year`='$Year' and  `care_crop_div_MEO_status`='1'";
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          if (($sql_get_detail_fetch['care_crop_div_mt_id_status']==1)&& ($sql_get_detail_fetch['care_crop_div_mt_id_status']==1)) {
                            ?>
                               <a class="btn btn-primary btn-xs" href="MEO_go_form_go.php?form_type=<?=web_encryptIt('ilab')?>&form_id=<?=web_encryptIt('4')?>&care_hhi=<?=web_encryptIt($sql_get_detail_fetch['care_slno'])?>&target=<?=web_encryptIt($months)?>&year=<?=web_encryptIt($Year)?>&village=<?=web_encryptIt($village)?>&form_uses=2" ><u>View</u></a>
                               <a class="btn btn-danger btn-xs" href="MEO_go_form_go.php?form_type=<?=web_encryptIt('ilab')?>&form_id=<?=web_encryptIt('4')?>&care_hhi=<?=web_encryptIt($sql_get_detail_fetch['care_slno'])?>&target=<?=web_encryptIt($months)?>&year=<?=web_encryptIt($Year)?>&village=<?=web_encryptIt($village)?>&form_uses=3&reset=<?=web_encryptIt($sql_get_detail_fetch['care_crop_serial_id'])?>" onclick="return confirm('Are you sure you want to delete this item?');"><u>Delete</u></a>
                            <?php
                          }else{
                            echo "--";
