...
if($_SESSION['meo_user']){
 ...
 $get_detail="SELECT * FROM `care_master_mtf_livestock_tarina_meo` WHERE `livestock`='$TYPE' and `care_LS_vlg_name`='$village' AND `care_LS_month`='$months' AND `care_LS_year`='$year' and `care_LS_MEO_status`='1' and `care_LS_slno`='$id'";
